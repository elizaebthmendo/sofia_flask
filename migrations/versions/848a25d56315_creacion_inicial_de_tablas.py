...
Revision ID: 848a25d56315
Revises: 
Create Date: 2026-06-17 08:49:03.268212
...
def upgrade():
    ...
    with op.batch_alter_table('producto', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('estrellas', sa.Float(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('producto', schema=None) as batch_op:
        batch_op.drop_column('estrellas')
